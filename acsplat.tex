...
\newcommand{\Sesame}{\textsc{Sesame}}
\newcommand{\Starlink}{\textsc{Starlink}}
\newcommand{\MIDAS}{\textsc{MIDAS}}
\newcommand{\vodesktop}{\textsc{VO-Desktop}}
\newcommand{\beanshell}{\textsc{BeanShell}}
...
The common tasks for an astronomers during spectral analysis consists of finding
...
into the \vodesktop , so that spectra and tables could be shared
...
Since 2011, the development of  \splatvo\ was resumed by German Astrophysical
Virtual Observatory (GAVO) in Heidelberg, Germany and in  the Astronomical
Institute of the Academy of Sciences of the Czech Republic (AI~ASCR).  Due to
the need for a spectral domain application with VO capabilities and good
scientific analysis functions, GAVO  decided to support development once the
original funding had stopped, concentrating on improved VO interface,
benefitting from the in-house development of VO server suite \dachs .  At about
the same time the  requirements for modifications of scientific functions (with
emphasis put on optical stellar spectroscopy) identified during everyday
analysis of spectra of emission line stars  in Stellar department of AI~ASCR
resulted in Bachelor and successive Diploma thesis focused on implementation of
new analytical and visualization function in collaboration with
...
disentangling or asteroismology studies.
...
\subsubsection{Display of spectra received by SAMP in the same window}
