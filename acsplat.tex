...
GHRS (thick blue short pieces) and \emph{IUE} low resolution spectra (thin
...
\caption{Composite plot of UV spectra of $\phi$~Per from  \emph{HST}
  GHRS spectrograph  selected in query on Fig.~\ref{fig:hst_query} and
  \emph{IUE} low resolution spectra selected earlier}
\label{fig:iuehst2}
\end{center}
\end{figure*}
