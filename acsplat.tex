...
tools prior to the conception of the VO,
and have subsequently been extended to add
...
Because of its powerful spectral model handling
...
the interstellar environment. In order to be able to directly use spectra from VO
resources, an SSAP interface was added recently. This closely resembles the
the visual appearance and functionality of the SSAP interface of the final
VO-compatible client for spectra analysis and the main subject of this article ---
\splatvo\ \citep[][\ascl{1402.008}]{sun243}.

\splatvo\ despite its early origin was revived recently and
is currently under intensive development, serving as a test-bed for newly
