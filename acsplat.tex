...
This current work  was supported by grant 13-08195S of Granting Agency of the
Czech Republic and  by the Czech project RVO:67985815. 
GAVO is funded by the German Federal Ministry of Education and Research.
We want to acknowledge also the work of Mark Taylor, who added to SPLAT-VO his
SAMP library  and Markus Demleitner who actively supports the new features in
SPLAT SSAP handling by the development of GAVO DaCHS server publishing suite.
The source code for the SPLAT-VO and all its libraries is open-source
available on Github at {\bf HOW TO REFERENCE IT}
