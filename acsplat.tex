...
\caption{Composite plot of UV spectra of $\Phi$~Per from  \emph{HST} GHRS spectrograph  selected in query on Fig.~\ref{fig:hst_query} and IUE low resolution spectra selected earlier}
\label{fig:iuehst2}
\end{center}
\end{figure*}
