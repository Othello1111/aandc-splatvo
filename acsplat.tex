...
\caption{Zeta Ophiuchi in $H_\alpha$ region, data taken with Ond\v{r}ejov Coud\`e
  spectrograph 700mm camera (green) and HEROS (blue) with overplotted line
...
The Starlink releases are available for Linux (32 and 64 bit) and OS X (Lion
and Snow Leopard).
